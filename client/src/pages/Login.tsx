    ...
    <div className="min-h-screen w-full flex bg-black">
        ...
        <div className="relative z-10 flex flex-col justify-end p-10 pb-14 w-full">
          ...
          <div className="flex flex-col gap-3">
            {[
              ...
              <div
                key={step.n}
                className="flex items-center gap-3 rounded-xl px-4 py-3 bg-white/10 text-white/60"
              >
                <span className="w-6 h-6 rounded-full text-xs font-semibold flex items-center justify-center shrink-0 bg-white/20 text-white/60">
                  {step.n}
                </span>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          <h2 className="text-white text-2xl font-semibold text-center mb-1">Login to Account</h2>
