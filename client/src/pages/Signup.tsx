            ...
            {[
              ...
              <div
                ...
                className={cn(
                  ...
                  step.active
                    ? "bg-dash-primary text-dash-page"
                    : "bg-dash-muted-btn text-dash-muted",
                )}
              >
                <span
                  className={cn(
                    ...
                    step.active
                      ? "bg-dash-page text-dash-primary"
                      : "bg-dash-muted-btn-hover text-dash-muted",
                  )}
                >
                  {step.n}
                </span>
      ...
      <div className="flex flex-1 items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleSubmit} noValidate>
            <div className="mb-4">
              <label className="mb-1.5 block font-dash-sans text-xs text-dash-muted">Username</label>
              <DashboardInput
                name="username"
                value={form.username}
            ...
            <div className="mb-2">
              <label className="mb-1.5 block font-dash-sans text-xs text-dash-muted">Password</label>
